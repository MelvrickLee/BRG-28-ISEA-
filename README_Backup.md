...
The installation process is straightforward, but it seems like the default memory allocation for video is insufficient for Ubuntu (will result in a black screen with nothing happening). 32mb is needed.

The installation process is slow. Maybe increasing the CPU will make it go faster?
...
ls -la displays more information on ls. But I do not know what the information is presenting yet.
